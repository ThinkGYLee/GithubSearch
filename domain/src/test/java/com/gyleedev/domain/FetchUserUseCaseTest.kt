...
class FetchUserUseCaseTest {
    ...
    @Test
    fun `검색 결과가 성공일 때 유저 정보를 저장하고 성공 상태를 반환한다`() =
        runTest {
            // Given
            val query = "android"
            val expectedId = 0L
    ...
    @Test
    fun `검색 결과가 존재하지 않는 유저일 때 유효한 실패 상태를 반환한다`() =
        runTest {
            // Given
            val query = "android"
            val expectedId = 0L
    ...
    @Test
    fun `할당량이 초과되었을 때 인증 필요 상태를 반환한다`() =
        runTest {
            // Given
            val query = "android"
            val expectedId = 0L
    ...
    @Test
    fun `알 수 없는 에러가 발생했을 때 실패 상태를 반환한다`() =
        runTest {
            // Given
            val query = "android"
            val expectedId = 0L
    ...
    @Test
    fun `유저 페치 중 예외가 발생하면 네트워크 에러 상태를 반환한다`() =
        runTest {
            // Given
            val query = "android"
            val expectedId = 0L
    ...
    @Test
    fun `유저 정보 저장 중 예외가 발생하면 네트워크 에러 상태를 반환한다`() =
        runTest {
            // Given
            val query = "android"
            val expectedFetchResult = UserFetchResult.Success(user = userModel)
    ...
    @Test
    fun `접근 시간 갱신 중 예외가 발생하면 네트워크 에러 상태를 반환한다`() =
        runTest {
            // Given
            val query = "android"
            val expectedId = 0L
