# ♊ GEMINI.md: GitHub Search Master Guide for AI

> **Status:** 🛡️ Project Master Instruction | **Target:** Gemini Paid Tier Senior Developer
...
모든 작업은 단발성 코드 생성이 아닌, 아래의 **5단계 프로세스**를 따라 진행합니다.
상세 내용은 `docs/ai/CODING_GUIDELINES.md`를 참조하세요.
...
4. **Verify (Logic Integrity)**: 
    ...
    *   **Hooks**: `.gemini/hooks/pre_commit_logic_check.py`를 실행하여 누락 여부를 최종 확정합니다.
    *   **Build**: Spotless, Compile, Test를 통한 자동 검증을 수행합니다.
5. **Review & Proposal**: 최종 변경 사항 요약 보고 및 컨벤션에 맞는 **커밋 메시지 제안** (실제 커밋은 금지)
...
* **🤖 AI 코딩 전략:** [CODING_GUIDELINES.md](./CODING_GUIDELINES.md)
...
* **✍️ 코딩 컨벤션:** [CONVENTION.md](../CONVENTION.md)
