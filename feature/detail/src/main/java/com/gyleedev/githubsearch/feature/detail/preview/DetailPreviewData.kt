...
object DetailPreviewData {
    ...
    val skydovesRepos = listOf(
        RepositoryModel(
            userGithubId = "skydoves",
            name = "All-In-One",
            description = ":necktie: Health care application for reminding health-todo lists and making healthy habits every day.",
            language = "Kotlin",
            stargazer = 122,
        ),
        RepositoryModel(
