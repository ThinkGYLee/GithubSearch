...
class SettingViewModelTest {
    ...
    @Test
    fun `테마 다이얼로그 이벤트를 받으면 상태가 양방향으로 토글된다`() = runTest {
        // Given
    ...
    @Test
    fun `언어 다이얼로그 이벤트를 받으면 상태가 양방향으로 토글된다`() = runTest {
        // Given
    ...
    @Test
    fun `리셋 다이얼로그 이벤트를 받으면 상태가 양방향으로 토글된다`() = runTest {
        // Given
    ...
    @Test
    fun `권한 이벤트를 받을 때 로그인 상태이면 로그아웃 다이얼로그가 열린다`() = runTest {
        // Given
    ...
    @Test
    fun `권한 이벤트를 받을 때 비로그인 상태이면 로그인 다이얼로그가 열린다`() = runTest {
        // Given
    ...
    @Test
    fun `로그인 또는 로그아웃 다이얼로그 닫기 이벤트를 받으면 명시적으로 false가 된다`() = runTest {
        // Given
    ...
    @Test
    fun `데이터 리셋 요청 시 UseCase를 호출하고 결과를 SharedFlow로 방출한다`() = runTest {
        // Given
    ...
    @Test
    fun `권한 취소 요청 시 UseCase를 호출하고 결과를 SharedFlow로 방출한다`() = runTest {
        // Given
