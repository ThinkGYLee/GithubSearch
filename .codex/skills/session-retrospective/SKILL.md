...
완료 전에 현재 diff, history record, 사용자 요구사항, 실행한 검증을 비교한다.
...
3. `python3 scripts/ai/generate_knowledge_index.py --check`와 `python3 scripts/ai/verify_knowledge_graph.py`를 실행한다.
